...
export default function MakeClassMaterials() {
    ...
    return (
        <s.Wrapper>
            ...
            {currentStep === 3 && <Step1 onNext={handleNext} />}
            ...
            {currentStep === 1 && <Step3 onNext={handleNext} onBack={handleBack} docs={docs} isGenerating={isDocPosting} agentId={agentId ?? undefined} isProcessing={isProcessing} />}
        </s.Wrapper>
    );
}
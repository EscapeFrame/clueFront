...
import { theme, blue } from '@/shared/theme/theme.styles';
...
export const SectionItem = styled.div<{ selected: boolean }>`
  ...
  background-color: ${({ selected }) =>
    selected ? blue[200] : theme.colors.white};
  border: 1px solid ${({ selected }) =>
    selected ? blue[500] : theme.colors.gray[300]};
  transition: all 0.2s;

  &:hover {
    background-color: ${({ selected }) =>
      selected ? blue[200] : theme.colors.gray[200]};
  }
`;

...
export const SubmitButton = styled.button<{ disabled: boolean }>`
  ...
  background-color: ${(props) =>
    props.disabled ? theme.colors.white : "#86C1FF"};
  color: ${(props) => (props.disabled ? theme.colors.gray[500] : "black")};
  border: 1px solid
    ${(props) => (props.disabled ? theme.colors.gray[300] : "#86C1FF")};
  border-radius: 4px;
  ${fonts.P3};
  ...
  &:hover {
    background-color: ${(props) =>
      props.disabled ? theme.colors.white : theme.colors.blue[600]};
  }
`;

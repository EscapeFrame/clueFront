...
export default function QuizHeader({ current, total, timeLeft, totalTime, onQuit }: Props) {
    const progress = Math.max((timeLeft / totalTime) * 100, 0);

    return (
        <s.Container>
            <s.Section>
                <s.QuitButton onClick={onQuit}><IoIosArrowBack />&nbsp;퀴즈 나가기</s.QuitButton>
